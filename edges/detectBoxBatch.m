...
fh = fopen('/home/t-yuche/car2cloud/video_list');
...
parfor vid = 1: length(videos)
    ...
    disp(video_name)
    frame_folder = strcat('/home/t-yuche/car2cloud/frames/', video_name);
    
    output_folder = strcat('/home/t-yuche/car2cloud/bbox/', video_name, '/');
    ...
    for i = 3:length(dir_data)
        ...
        outfile_path = strcat('/home/t-yuche/car2cloud/bbox/', video_name, '/' , frame_name(1:length(frame_name)-4), '.bbx');
        if (exist(outfile_path, 'file')), continue; end
