    ...
    for train_idx, test_idx in kf:
        ...
        for tid, video_name in enumerate(videos):
            if video_name in test_video_names:
                # load test data
                #continue
                test_pos_samples += [[x[7]] for x in train_data[video_name]['1']]
                test_neg_samples += [[x[7]] for x in train_data[video_name]['0']]
           
            else: 
                pos_samples += [[x[7]] for x in train_data[video_name]['1']]
                neg_samples += [[x[7]] for x in train_data[video_name]['0']]
        ...
        fst_clf = tree.DecisionTreeClassifier(random_state = 0)
