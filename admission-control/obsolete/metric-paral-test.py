...
if __name__ == "__main__":
    ...
    for retained_frame_rate in [0.01, 0.03, 0.05, 0.07, 0.1, 0.3, 0.5, 0.7]:
        ...
        k = 10
        ave_top_wd_dist, occur_dist = top_word_timely_measure(k, all_tf, all_tfs_list, subsampled_tfs_list)
        ave_hist_dist, timely_dist = hist_timely_measure(all_tfs_list, subsampled_tfs_list)
        ...
        fh.write('retained_rate:' + str(retained_frame_rate) + '\n')
        fh.write('detailed_measure:' + str(detailed_measure(all_tf,subsampled_tf)) + '\n')
        fh.write('all_l1_dist:' + str(l1_dist) + '\n')
        fh.write('all_corr:' + str(correl_score) + '\n')
        fh.write('all_chisq:' + str(chisq_dist) + '\n')
        fh.write('top_10_dist:' + str(ave_top_wd_dist) + '\n')
        fh.write('window_l1_dist:' + str(ave_hist_dist) + '\n\n')
    fh.close()
