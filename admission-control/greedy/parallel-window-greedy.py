...
def remove_unimportantwords(tf, UNIMPORTANTWORD_THRESH):
    new_tf = {}
    for w in tf:
        if tf[w] > UNIMPORTANTWORD_THRESH:
            new_tf[w] = tf[w]
...
if __name__ == "__main__":
    ...
    for vid, video_name in enumerate(videos):
        ...
        print THRESH, vid, video_name
        outfilepath = os.path.join('window-greedy-log-' + str(UNIMPORTANTWORD_THRESH),  video_name + '_' + str(THRESH)  + '_gtframe.pickle')
